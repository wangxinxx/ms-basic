...
<div class="form-group ms-form-group">	
	...
	<script type="text/javascript">
	   ...
	   var ue = UE.getEditor('editor_${name}', {
       		...
       		// 服务器统一请求接口路径
       		serverUrl: URL + "jsp/msController.jsp?jsonConfig={videoUrlPrefix:'${base}',fileUrlPrefix:'${base}',imageUrlPrefix:'${base}',imagePathFormat:'/upload/editor/${appId?default(0)}/{time}',filePathFormat:'/upload/editor/${appId}/{time}',videoPathFormat:'/upload/editor/${appId}/{time}'}", 
